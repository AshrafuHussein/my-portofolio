export function getSylvaHeroHtml(): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">
<title>Ashrafu Hussein — Flutter & Supabase Software Engineer</title>
...
<style>
  ...
  *,*::before,*::after{ box-sizing:border-box; margin:0; padding:0; }
  ...
  .hero{
    ...
    isolation:isolate;
    background:
      radial-gradient(64% 52% at 27% 84%, rgba(16,185,129,.07) 0%, rgba(16,185,129,0) 72%),
      radial-gradient(70% 60% at 92% 8%,  rgba(5,150,105,.08) 0%, rgba(5,150,105,0) 68%),
      #080f0b;
  }
  .hero::after{
    content:'';
    ...
    background:
      radial-gradient(72% 44% at 50% 117%, rgba(209,250,229,.32) 0%, rgba(16,185,129,.14) 42%, rgba(5,150,105,.03) 72%, rgba(8,15,11,0) 88%),
      linear-gradient(180deg, rgba(8,15,11,0) 54%, rgba(8,15,11,.03) 78%, rgba(8,15,11,.85) 100%);
  ...
  .dock-wrap{
    ...
    top:calc(34 * var(--u)); left:0; right:0;
  ...
  .dock{
    ...
    background:
      ...
      rgba(10,18,13,.82);
    box-shadow:0 calc(8 * var(--u)) calc(22 * var(--u)) rgba(4,10,7,.50),
               inset 0 1px rgba(16,185,129,.15);
    isolation:isolate;
  }
  .dock-item{
    ...
    letter-spacing:calc(1.4 * var(--u)); text-transform:uppercase;
    white-space:nowrap;
  ...
  .dock-item[data-near="true"]{
    ...
    background:rgba(14,26,19,.96);
    box-shadow:0 calc(7 * var(--u)) calc(16 * var(--u)) rgba(4,10,7,.45);
  }
  .dock-item .glyph{
  ...
  .dock-mark{
    ...
    background:#10b981; border-color:#10b981; color:#041008;
    overflow:hidden; font-weight:700; font-size:calc(14 * var(--u));
  }
  .dock-mark svg{ width:58%; height:58%; display:block; fill:currentColor; }
  .dock-mark[data-near="true"]{ background:#34d399; border-color:#34d399; color:#020a05; }

  .dock-item.is-active{
    background:var(--card); border-color:var(--card); color:var(--card-ink);
    box-shadow:0 calc(6 * var(--u)) calc(16 * var(--u)) rgba(4,10,7,.35);
  }
  .dock-item.is-active .glyph{ opacity:.85; }
  .dock-item--enter{ color:#10b981; background:rgba(16,185,129,.12); border-color:rgba(16,185,129,.25); }
  .dock-item--enter[data-near="true"]{ color:#34d399; background:rgba(16,185,129,.24); }
  ...
  [data-spec]::after{
    ...
    background:conic-gradient(from var(--spec-angle) at 50% 50%,
      rgba(16,185,129,0) 0deg, rgba(16,185,129,.08) 14deg, rgba(52,211,153,.95) 28deg,
      rgba(16,185,129,.16) 46deg, rgba(16,185,129,0) 68deg, rgba(16,185,129,0) 180deg,
      rgba(16,185,129,.08) 194deg, rgba(52,211,153,.95) 208deg, rgba(16,185,129,.16) 226deg,
      rgba(16,185,129,0) 248deg, rgba(16,185,129,0) 360deg);
  ...
  .headline{
    ...
    left:calc(46 * var(--u)); top:calc(195 * var(--u));
  ...
  .lede{
    position:absolute; z-index:4;
    left:calc(520 * var(--u)); top:calc(198 * var(--u));
  ...
  .liquid-plate{
    ...
    background:
      ...
      rgba(8,16,11,.50);
    box-shadow:
      0 calc(var(--h) * 0.08) calc(var(--h) * 0.18) rgba(0,0,0,.45),
      0 calc(var(--h) * 0.24) calc(var(--h) * 0.50) rgba(0,0,0,.35),
      0 calc(var(--h) * 0.48) calc(var(--h) * 0.96) rgba(0,0,0,.22),
      inset 0 1px 0 rgba(16,185,129,.20),
      inset 0 calc(var(--h) * -0.02) calc(var(--h) * 0.05) rgba(16,185,129,.08);
    transition:box-shadow .38s var(--ease), background .38s var(--ease);
  }
  .liquid-stage.hot .liquid-plate{
    background:
      linear-gradient(180deg, rgba(255,255,255,.12), rgba(255,255,255,.02) 44%, rgba(255,255,255,0) 64%),
      rgba(10,22,14,.62);
    box-shadow:
      0 calc(var(--h) * 0.10) calc(var(--h) * 0.22) rgba(0,0,0,.52),
      0 calc(var(--h) * 0.32) calc(var(--h) * 0.66) rgba(0,0,0,.40),
      0 calc(var(--h) * 0.66) calc(var(--h) * 1.32) rgba(0,0,0,.26),
      inset 0 1px 0 rgba(52,211,153,.32),
      inset 0 calc(var(--h) * -0.02) calc(var(--h) * 0.05) rgba(16,185,129,.12);
  }
  ...
  .liquid-button:focus-visible{
    outline:calc(4 * var(--lu)) solid rgba(52,211,153,.65);
  ...
  .liquid-stage.press .liquid-plate{
    background:
      ...
      rgba(6,12,8,.65);
    box-shadow:
      0 calc(var(--h) * 0.04) calc(var(--h) * 0.11) rgba(0,0,0,.55),
      0 calc(var(--h) * 0.13) calc(var(--h) * 0.32) rgba(0,0,0,.45),
      0 calc(var(--h) * 0.27) calc(var(--h) * 0.62) rgba(0,0,0,.30),
      inset 0 1px 0 rgba(16,185,129,.12);
  ...
  .play-ring{
    ...
    border:1px solid rgba(16,185,129,.22); border-radius:50%;
  }
  .play-ring::after{
    content:''; position:absolute; inset:calc(-1 * var(--u));
    border:1px solid rgba(52,211,153,.45); border-radius:50%;
  ...
  .stat .mark{ width:calc(32 * var(--u)); height:calc(32 * var(--u)); flex:none; margin-top:calc(2 * var(--u)); color:rgba(52,211,153,.65); }
  ...
  .stat dt, .stat dd{ text-shadow:0 calc(2 * var(--u)) calc(16 * var(--u)) rgba(4,10,7,.7); }
  .stat .mark svg{ filter:drop-shadow(0 calc(2 * var(--u)) calc(10 * var(--u)) rgba(4,10,7,.7)); }
  .stat dd{ font-size:calc(13.5 * var(--u)); font-weight:600; color:#ecfdf5; line-height:calc(21 * var(--u)); }

  /* ── cards ───────────────────────────────────────────────────────────── */
  .card{
    position:absolute;
    background:var(--card); border-radius:calc(46 * var(--u));
    box-shadow:0 calc(30 * var(--u)) calc(70 * var(--u)) rgba(4,10,7,.42);
  ...
  .card .label{
    ...
    font-size:calc(15 * var(--u)); font-weight:400; color:var(--card-label);
  }
  .card h2{
    position:absolute; left:calc(38 * var(--u));
    font-size:calc(25 * var(--u)); line-height:calc(28 * var(--u));
    font-weight:500; letter-spacing:calc(-0.4 * var(--u)); color:var(--card-ink);
  }
  .card--about .label{ top:calc(152 * var(--u)); }
  .card--about h2{ top:calc(177 * var(--u)); width:calc(240 * var(--u)); }
  .card--stove .label{ top:calc(45 * var(--u)); }
  .card--stove h2{ top:calc(70 * var(--u)); width:calc(250 * var(--u)); }
  .card figure{
    position:absolute; left:calc(14 * var(--u)); right:calc(14 * var(--u));
    border-radius:calc(34 * var(--u)); overflow:hidden;
    isolation:isolate; background:#0f1d14;
  }
  ...
  .card:hover .portal-media img{ transform:scale(1.13); filter:saturate(1.05) contrast(1.05); }
  .pixel-reveal{
  ...
  .card figure::after{
    ...
    background:linear-gradient(90deg,transparent,rgba(16,185,129,.2) 42%,rgba(209,250,229,.72) 54%,transparent);
  }
  ...
  .card .knob, .knob--about{
    ...
    box-shadow:0 calc(6 * var(--u)) calc(16 * var(--u)) rgba(4,10,7,.22);
  ...
  .card .knob svg, .knob--about svg{ width:calc(19 * var(--u)); height:calc(19 * var(--u)); display:block; color:#064e3b; }
  .card .knob:hover, .knob--about:hover{ transform:scale(1.12) rotate(8deg); background:#ecfdf5; }
  .card:hover{ box-shadow:0 calc(38 * var(--u)) calc(84 * var(--u)) rgba(4,10,7,.52); }
  ...
  .scroll .track{ position:relative; width:1px; height:calc(56 * var(--u)); background:rgba(16,185,129,.22); overflow:hidden; }
  .scroll .track::after{
  ...
  a:focus-visible, button:focus-visible{
    outline:2px solid rgba(52,211,153,.85);
    outline-offset:calc(4 * var(--u));
    border-radius:calc(6 * var(--u));
  }
  .card .knob:focus-visible, .knob--about:focus-visible, .play:focus-visible{ outline-color:rgba(16,185,129,.9); }
  ...
  @media (max-width:900px){
    ...
    .hero::after{
      background:
        radial-gradient(90% 30% at 50% 74%, rgba(16,185,129,.25) 0%, rgba(16,185,129,.08) 46%, rgba(8,15,11,0) 82%),
        linear-gradient(180deg, rgba(8,15,11,0) 62%, rgba(8,15,11,.5) 100%);
    }
    ...
    .headline{ left:calc(34 * var(--u)); top:calc(128 * var(--u)); font-size:calc(54 * var(--u)); line-height:calc(58 * var(--u)); }
    .lede{ left:calc(34 * var(--u)); top:calc(288 * var(--u)); width:calc(400 * var(--u)); font-size:calc(18 * var(--u)); line-height:calc(26 * var(--u)); }
    .pill-clip{
    ...
    .card--about h2{ top:calc(124 * var(--u)); width:calc(400 * var(--u)); font-size:calc(30 * var(--u)); line-height:calc(34 * var(--u)); }
    .card--stove{ left:calc(34 * var(--u)); top:calc(1324 * var(--u)); width:calc(692 * var(--u)); height:calc(268 * var(--u)); }
    .card--stove h2{ font-size:calc(30 * var(--u)); width:calc(400 * var(--u)); }
    ...
    .ghost{ font-size:calc(170 * var(--u)); letter-spacing:calc(12 * var(--u)); bottom:calc(660 * var(--u)); left:calc(-10 * var(--u)); }
  }
</style>
</head>
<body>
...
<main class="hero" id="hero">
  ...
  <div class="dock-wrap">
    <nav class="dock par-dock" style="--pd:5" data-spec aria-label="Primary">
      <a class="dock-item dock-mark" data-dock data-spec data-burst href="#home" onclick="navigateParent('#home'); return false;" style="--d:120ms" aria-label="Ashrafu Hussein — Home">
        AH
      </a>
      <a class="dock-item is-active" data-dock data-spec data-burst href="#projects" onclick="navigateParent('#projects'); return false;" style="--d:180ms">
      ...
      <a class="dock-item" data-dock data-spec data-burst href="#experience" onclick="navigateParent('#experience'); return false;" style="--d:230ms">
        <span class="glyph" aria-hidden="true">
      ...
      <a class="dock-item" data-dock data-spec data-burst href="#skills" onclick="navigateParent('#skills'); return false;" style="--d:280ms">
        <span class="glyph" aria-hidden="true">
          <svg viewBox="0 0 16 16"><path d="M4 2.4h5.3L12 5.1v8.5H4z"/><path d="M9.2 2.4V5h2.7"/><path d="M6 8.4h4M6 10.8h2.8"/></svg>
        </span>
        <span>Skills</span>
      </a>
      <a class="dock-item dock-item--enter" data-dock data-spec data-burst href="#contact" onclick="navigateParent('#contact'); return false;" style="--d:330ms">
        <span class="glyph" aria-hidden="true">
  ...
  <div class="stage" id="stage">
    ...
    <div class="ghost fade" style="--d:1150ms" aria-hidden="true">ASHRAFU</div>
    ...
    <article class="card card--about mask" style="--d:760ms; --pd:10; --pr:2.2">
      <figure class="portal" data-delay="920">
        <span class="portal-media"><img src="/img/ashrafu-2.png" alt="Ashrafu Hussein" loading="eager" decoding="async"></span>
        <canvas class="pixel-reveal" aria-hidden="true"></canvas>
      </figure>
      <p class="label">Our Ethos</p>
      <h2>Great software feels invisible.</h2>
    </article>

    <!-- the About knob rides *outside* the card -->
    <span class="knob-float" style="--pd:10; --pr:2.2">
      <button class="knob knob--about mask-circle" style="--d:1100ms" aria-label="About Ashrafu" onclick="navigateParent('#about')">
    ...
    <h1 class="headline" style="--pd:18; --pr:1.2">
      <span><i style="--d:260ms">Ashrafu Hussein</i></span>
      <span><i style="--d:360ms" class="highlight">Flutter &amp; Supabase</i></span>
    </h1>

    <p class="lede mask" style="--d:480ms; --pd:14; --pr:1">
      Engineering production Flutter mobile apps and scalable Supabase cloud architectures with clean code and reactive state.
    </p>
    ...
    <div class="pill-clip">
      <div class="pill mask" style="--d:600ms; --pd:15; --pr:1.4">
        <div class="liquid-stage liquid-stage--explore" data-liquid-metal="explore">
          ...
          <button class="liquid-button liquid-button--explore btn" type="button" onclick="navigateParent('#projects')">
            ...
            <span class="lbl">Explore Featured Work</span>
          </button>
        </div>
      </div>
    </div>
      ...
      <span class="play-clip">
        <span class="play-glass mask-circle" style="--d:900ms">
          <span class="liquid-stage liquid-stage--play" data-liquid-metal="play">
            ...
            <canvas class="liquid-fx" aria-hidden="true"></canvas>
            <button class="liquid-button liquid-button--play btn" type="button" aria-label="Resume / CV" onclick="downloadCV()">
    ...
    <dl class="stat stat--a mask" style="--d:700ms; --pd:12">
      ...
      <div><dt>Mobile Stack</dt><dd>Flutter &amp; Dart</dd></div>
    </dl>
    ...
    <dl class="stat stat--b mask" style="--d:770ms; --pd:13">
      ...
      <div><dt>Incoming Intern</dt><dd>eGA (Oct 2026)</dd></div>
    </dl>

    <article class="card card--stove mask" style="--d:880ms; --pd:22; --pr:2.4">
      <p class="label">Featured Mobile App</p>
      <h2>Wakazi Community App</h2>
      <figure class="portal" data-delay="1080">
        <span class="portal-media"><img src="/img/wakazi app.jpg" alt="Wakazi Community App" loading="eager" decoding="async"></span>
        <canvas class="pixel-reveal" aria-hidden="true"></canvas>
      </figure>
      <button class="knob" aria-label="Explore Wakazi App" onclick="navigateParent('#projects')">
    ...
    <a class="scroll mask" style="--d:1040ms; --pd:9" href="#projects" onclick="navigateParent('#projects'); return false;">Discover<span class="track"></span></a>
...
function navigateParent(hash) {
  try {
    if (window.parent && window.parent !== window) {
      window.parent.postMessage({ type: 'navigate', hash: hash }, '*');
      return;
    }
  } catch (e) {}
...
function downloadCV() {
  try {
    if (window.parent && window.parent !== window) {
      window.parent.postMessage({ type: 'download-cv' }, '*');
      return;
    }
  } catch (e) {}
...
const E = window.__E = {
  base: 0.20, hot: 0.82, chromA: 0.42, chromS: 0.030, speed: 0.070, top: 0.35, press: 0.85, ripple: 1.60
};
...
if(!gl){
  document.body.innerHTML = '<p style="color:#888;font:14px system-ui">WebGL2 is required.</p>';
} else {
...
(function () {
  ...
  function wireMaterial() {
    return new THREE.ShaderMaterial({
      ...
      fragmentShader: [
        ...
        '  vec3 col = mix(vec3(0.10, 0.72, 0.46), vec3(0.86, 1.00, 0.90), rim);',
  ...
  function buildAmbient() {
    ...
    glowMesh = new THREE.Mesh(geo, new THREE.MeshBasicMaterial({
      map: radialTexture(256, [[0, 'rgba(16,185,129,0.30)'], [0.42, 'rgba(5,150,105,0.10)'], [1, 'rgba(16,185,129,0)']]),
      transparent: true, depthWrite: false, depthTest: false,
      blending: THREE.AdditiveBlending
    }));
    ...
    poleTex = radialTexture(64, [[0, 'rgba(255,255,255,1)'], [0.35, 'rgba(209,250,229,0.5)'], [1, 'rgba(16,185,129,0)']]);
  ...
  function renderFrame() {
    ...
    if (scanning) {
      scanT += dt;
      var p = Math.min(1, scanT / SCAN_DUR);
      var e = sstep(0, 1, p);
      uScanR.value = e * scanMax;
      uWire.value = Math.max(0, 1 - sstep(0.40, 1.0, p));
      if (p >= 1) {
        scanning = false;
        uScanOn.value = 0;
        uWire.value = 0;
        wireMeshes.forEach(function (m) { scene.remove(m); m.geometry.dispose(); m.material.dispose(); });
        wireMeshes = [];
      }
    }

    if (bf) bf(dt, uTime.value);
